...
function SearchContent() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 w-full max-w-[1280px] mx-auto px-margin-mobile md:px-margin-desktop pt-6 md:pt-8 pb-24 md:pb-xl flex flex-col gap-6 md:gap-8">
        {/* Search Section */}
        <section className="w-full relative mt-2 md:mt-3">
          <SearchBar 
            value={searchQuery}
        ...
        {/* Results Section */}
        <section className="flex flex-col gap-lg mt-4">
